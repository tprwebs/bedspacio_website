...
export default function CreateBranchModal ({ isModalOpen }:CreateBranchModalProp ) {
                    ...
                    <div className='flex flex-col w-full gap-[1rem]'>
                        <div className='flex flex-col gap-2'>
                            ...
                            <div className='flex flex-col items-start w-full gap-1'>
                                ...
                                <input type="text" placeholder='Enter the name of the branch here' className='w-full p-[1rem] rounded-[10px] bg-[#1D242B]/10 border border-[#1D242B]/25 hover:border-[#1D242B]/50 focus:outline-none focus:border-[#0077C0]' />
                            </div>
                        ...
                        <div className='flex flex-col w-full gap-1'>
                            ...
                            <select name="property_manager" id="property_manager" className='w-full p-[1rem] rounded-[10px] bg-[#1D242B]/10 border border-[#1D242B]/25 hover:border-[#1D242B]/50 focus:outline-none focus:border-[#0077C0]'>
                                <option value="pm_1">Jennifer Sernicula pero Pembo</option>
                                <option value="pm_2">Jennifer Sernicula pero Makati</option>
                            </select>
                        </div>
                    </div>
                </div>
