        ...
        <div className="flex w-full min-h-screen">
            <div className="flex flex-col items-start w-full px-[8rem] py-[1rem]">
                ...
                <div className="grid grid-cols-[2fr_3fr] w-full h-auto py-[1rem] gap-[1rem]">
                    ...
                    <div className="flex flex-col items-center gap-4 w-full border-box">
                        <div className="flex flex-col items-start gap-1 w-full">
                            <span>Name</span>
                            <input type="text" placeholder="Enter room name here..." className="w-full p-2 border border-[#1D242B]/50 rounded-[10px] focus:outline-[#0077C0]"/>
                        </div>

                        <div className="flex flex-col items-start gap-1 w-full">
                            <span>Description</span>
                            <textarea name="description" id="room_description" rows={5} placeholder="Enter description here..." className="w-full p-2 border border-[#1D242B]/50 rounded-[10px] focus:outline-[#0077C0]"></textarea>
                        </div>
                        ...
                        {typeSelected === 'apartment' && (
                            <>
                                <div className="flex flex-col w-full items-start gap-1">
                                    <span>Capacity</span>
                                    <input type="text" placeholder="Enter maximum capacity" className="w-full p-2 border border-[#1D242B]/50 rounded-[10px] focus:outline-[#0077C0]"/>
                                </div>

                                <div className="flex flex-col w-full items-start gap-1">
                                    <span>Available Slot</span>
                                    <input type="text" placeholder="Enter available slot" className="w-full p-2 border border-[#1D242B]/50 rounded-[10px] focus:outline-[#0077C0]"/>
                                </div>
                            </>
                        )}
                                ...
                                <div className="flex items-center gap-4 w-full">
                                    <div className="flex flex-col gap-2 w-full">
                                        <div className="flex items-center gap-1 w-full">
                                            ...
                                            <input type="text" placeholder="Enter max number of upper decks" className="w-full p-2 border border-[#1D242B]/50 bg-[#FAFAFA] rounded-[10px] focus:outline-[#0077C0]"/>
                                        </div>

                                        <div className="flex items-center gap-1 w-full">
                                            <span className="whitespace-nowrap">Total Lower Decks</span>
                                            <input type="text" placeholder="Enter max number of lower decks" className="w-full p-2 border border-[#1D242B]/50 bg-[#FAFAFA] rounded-[10px] focus:outline-[#0077C0]"/>
                                        </div>
                                    ...
                                    <div className="flex flex-col gap-2 w-full">
                                        <div className="flex items-center gap-1 w-full">
                                            ...
                                            <input type="text" placeholder="Enter available number of upper decks" className="w-full p-2 border border-[#1D242B]/50 bg-[#FAFAFA] rounded-[10px] focus:outline-[#0077C0]"/>
                                        </div>

                                        <div className="flex items-center gap-1 w-full">
                                            <span className="whitespace-nowrap">Available Lower Decks</span>
                                            <input type="text" placeholder="Enter available number of lower decks" className="w-full p-2 border border-[#1D242B]/50 bg-[#FAFAFA] rounded-[10px] focus:outline-[#0077C0]"/>
                                        </div>
                ...
                <div className="flex items-center w-full items-end justify-end gap-1">
                    <button className="flex items-center px-4 py-2 border-2 border-[#0077C0] bg-[#0077C0] text-[#FAFAFA] font-bold rounded-[10px] cursor-pointer">Save</button>
